...
Route::group(['prefix' => CP_ROUTE, 'middleware' => ['auth']], function () {
    ...
    Route::group(['prefix' => 'pages'], function () {
        ...
        get('localize/{uuid}/{locale}', 'PublishController@createLocalizedPage')->name('page.localize');
    ...
    Route::group(['prefix' => 'collections/entries'], function () {
        ...
        get('localize/{uuid}/{locale}', 'PublishController@createLocalizedEntry')->name('entry.localize');
    ...
    Route::group(['prefix' => 'taxonomies/terms'], function () {
        ...
        get('localize/{uuid}/{locale}', 'PublishController@createLocalizedTaxonomy')->name('term.localize');
    ...
    Route::group(['prefix' => 'globals'], function () {
        ...
        get('localize/{slug}/{locale}', 'PublishController@createLocalizedGlobal')->name('globals.localize');
    });
    ...
    Route::group(['prefix' => 'assets'], function () {
        ...
        Route::group(['prefix' => 'folders'], function () {
            ...
            get('{container}/{path?}', 'AssetFoldersController@edit')->where('path', '.*')->name('assets.folder.edit');
            post('{container}/{path?}', 'AssetFoldersController@update')->where('path', '.*')->name('assets.folder.update');
        });
        ...
        get('browse/{container}/{folder?}', 'AssetsController@browse')->where('folder', '.*')->name('assets.browse');
    ...
    Route::group(['prefix' => 'forms'], function () {
        ...
        get('{form}/submission/{submission}/delete', 'FormsController@deleteSubmission')->name('form.submission.delete');
    ...
    get('import/{importer}', 'ImportController@import')->name('importer');
    post('import/{importer}', 'ImportController@upload')->name('importer.upload');
 ...
 */
Route::get(Config::get('assets.image_manipulation_route').'/{id}/{filename?}', 'GlideController@generate');
